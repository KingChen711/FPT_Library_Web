      ...
      <div className="mt-4 rounded-md border p-4">
        ...
        {cards.length === 0 ? (
          <div className="flex justify-center p-4">
            <NoResult
              title={t("Cards Not Found")}
              description={t(
                "No cards matching your request were found Please check your information or try searching with different criteria"
              )}
            />
          </div>
        ) : (
                ...
                <TableBody>
                  {cards.map((card) => (
                    <TableRow key={card.libraryCardId}>
                      ...
                      <Hidable
                        hide={!columns.includes(Column.FULLNAME_ON_CARD)}
                      >
                        <TableCell className="text-nowrap">
                          {card?.fullName || "-"}
                        </TableCell>
                      ...
                      <Hidable
                        hide={!columns.includes(Column.ALLOW_BORROW_MORE)}
                      >
                        <TableCell className="text-nowrap">
                          <div className="flex justify-center">
                            {card ? (
                      ...
                      <Hidable
                        hide={
                          !columns.includes(Column.ALLOW_BORROW_MORE_REASON)
                        }
                      >
                        <TableCell className="text-nowrap">
                          <div className="flex justify-center">
                      ...
                      <Hidable
                        hide={!columns.includes(Column.SUSPENSION_REASON)}
                      >
                        <TableCell className="text-nowrap">
                          <div className="flex justify-center">
                      ...
                      <Hidable
                        hide={!columns.includes(Column.TRANSACTION_CODE)}
                      >
                        <TableCell className="text-nowrap">
                          <div className="flex justify-center">
