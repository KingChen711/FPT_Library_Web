...
import { deleteTrackingDetail } from "@/actions/trackings/delete-tracking-detail"
...
function DeleteTrackingDetailDialog({
  open,
  setOpen,
  trackingId,
  trackingDetailId,
  ...
  const handleDeleteTracking = () => {
    startTransition(async () => {
      const res = await deleteTrackingDetail(trackingId, trackingDetailId)
      if (res.isSuccess) {
        toast({
...
export default DeleteTrackingDetailDialog
