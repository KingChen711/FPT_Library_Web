...
import CreateAuthorDialog from "@/app/[locale]/management/authors/_components/create-author-dialog"
import AuthorCard from "@/app/[locale]/management/books/_components/create-book-form/author-card"
...
function AuthorsField({
  ...
  const watchAuthor = form.watch(`libraryItem.author`)
  ...
  useEffect(() => {
    ...
    if (authorItems.length > 0) {
      ...
      form.setValue(`libraryItem.authorIds`, [authorItems[0].authorId])
      return
    }
    ...
    form.setValue(`libraryItem.authorIds`, [])
      ...
      render={({ field }) => (
        <FormItem className="flex flex-col">
              ...
              return (
                <AuthorCard
                  ...
                  onClose={() => {
                    if (isPending) return
                    form.setValue(
                      `libraryItem.authorIds`,
                      form
                        .getValues(`libraryItem.authorIds`)
                        ?.filter((t) => t !== authorId)
                    )
                  }}
                />
                      ...
                      <AuthorCard
                        ...
                        onClick={() => {
                          ...
                          form.setValue(
                            ...
                            Array.from(
                              new Set([
                                ...(form.getValues(`libraryItem.authorIds`) ||
                                  []),
                                author.authorId,
                              ])
                            )
          ...
          <div className="flex items-center gap-1 text-sm text-muted-foreground">
            ...
            {form.watch(`libraryItem.author`) ||
              form.watch(`libraryItem.additionalAuthors`) || (
