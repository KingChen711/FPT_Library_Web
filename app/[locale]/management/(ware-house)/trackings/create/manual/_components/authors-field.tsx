...
function AuthorsField({
  ...
  useEffect(() => {
    ...
    if (authorItems.length > 0) {
      ...
      form.setValue(`warehouseTrackingDetails.${index}.libraryItem.authorIds`, [
        authorItems[0].authorId,
      ])
      return
    }
  ...
  return (
    <FormField
      ...
      name={`warehouseTrackingDetails.${index}.libraryItem.authorIds`}
      render={({ field }) => (
