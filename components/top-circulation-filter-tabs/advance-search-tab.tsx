...
const AdvancedSearchTab = ({ queries, setQueries, setSearchParams }: Props) => {
  ...
  const handleAddFov = () => {
    if (queries.length >= libraryItemAdvancedFilters.length) return
        ...
        <PopoverContent className="w-[200px] shrink-0 p-0" side="bottom">
          <Command>
            ...
            <CommandList className="max-h-[50dvh] overflow-y-auto">
              ...
              <CommandGroup>
                {libraryItemAdvancedFilters.map((f) => {
