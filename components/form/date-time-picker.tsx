...
function TimeField(props: AriaTimeFieldProps<TimeValue>) {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "inline-flex h-9 w-full flex-1 rounded-md border border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
...
function DateField(props: AriaDatePickerProps<DateValue>) {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "inline-flex h-9 flex-1 shrink-0 items-center rounded-l-md border border-r-0 border-input bg-transparent py-2 pl-3 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        props.isDisabled ? "cursor-not-allowed opacity-50" : ""
      )}
    >
      {state.segments.map((segment, i) => (
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "flex !h-9 w-full items-center rounded-md ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
      )}
