...
import { BadgeCheck, ChevronsUpDown, LogOut, School } from "lucide-react"
      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              <School className="mx-auto size-16" />
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-semibold">HTPV</span>
                <span className="truncate text-xs">E-Library</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
