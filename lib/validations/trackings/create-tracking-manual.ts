...
export const warehouseTrackingDetailSchema = z
  .object({
...
export const createTrackingManualSchema = z.object({
...
export type TCreateTrackingManualSchema = z.infer<
  typeof createTrackingManualSchema
>
